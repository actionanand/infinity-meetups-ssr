...
const css$2 = {
	code: "article.svelte-if5wql.svelte-if5wql{box-shadow:0 2px 8px rgba(0, 0, 0, 0.26);border-radius:5px;background:white;margin:1rem}header.svelte-if5wql.svelte-if5wql,.content.svelte-if5wql.svelte-if5wql,footer.svelte-if5wql.svelte-if5wql{padding:1rem}.image.svelte-if5wql.svelte-if5wql{width:100%;height:14rem}.image.svelte-if5wql img.svelte-if5wql{width:100%;height:100%;object-fit:cover}h1.svelte-if5wql.svelte-if5wql{font-size:1.25rem;margin:0.5rem 0;font-family:\"Roboto Slab\", sans-serif}h2.svelte-if5wql.svelte-if5wql{font-size:1rem;color:#808080;margin:0.5rem 0}p.svelte-if5wql.svelte-if5wql{font-size:1.25rem;margin:0}div.svelte-if5wql.svelte-if5wql{text-align:right}.changing-fav.svelte-if5wql.svelte-if5wql{font:inherit;border:1px solid #cf0056;background:#cf0056;padding:0.5rem 1rem;color:white;border-radius:5px;box-shadow:1px 1px 3px rgba(0, 0, 0, 0.26);cursor:progress}",
	map: "{\"version\":3,\"file\":\"MeetupItem.svelte\",\"sources\":[\"MeetupItem.svelte\"],\"sourcesContent\":[\"<script>\\n  import { createEventDispatcher } from 'svelte';\\n\\n  import meetups from '../../store/meetups-store.js';\\n\\n  import Button from '../UI/Button.svelte';\\n  import Badge from '../UI/Badge.svelte';\\n\\n  export let title;\\n  export let subtitle;\\n  export let imageUrl;\\n  export let description;\\n  export let address;\\n  export let email;\\n  export let id;\\n  export let isFav;\\n\\n  let isLoading = false;\\n\\n  const dispatch = createEventDispatcher();\\n\\n  function onToggleFavorite() {\\n    isLoading = true;\\n    fetch(`https://vue-http-exmp-default-rtdb.firebaseio.com/meetups/${id}.json`, {\\n        method: 'PATCH',\\n        body: JSON.stringify({ isFavorite: !isFav}),\\n        headers: {\\n          'Content-Type': 'application/json'\\n        }\\n      }).then(res => {\\n        if(!res.ok) {\\n          throw new Error('Error changing favorite status!');\\n        }\\n        isLoading = false;\\n        meetups.toggleFavorite(id);\\n      }).catch(err => {\\n        isLoading = false;\\n        console.log(err);\\n      });\\n  }\\n</script>\\n\\n<style>\\n  article {\\n    box-shadow: 0 2px 8px rgba(0, 0, 0, 0.26);\\n    border-radius: 5px;\\n    background: white;\\n    margin: 1rem;\\n  }\\n\\n  header,\\n  .content,\\n  footer {\\n    padding: 1rem;\\n  }\\n\\n  .image {\\n    width: 100%;\\n    height: 14rem;\\n  }\\n\\n  .image img {\\n    width: 100%;\\n    height: 100%;\\n    object-fit: cover;\\n  }\\n\\n  h1 {\\n    font-size: 1.25rem;\\n    margin: 0.5rem 0;\\n    font-family: \\\"Roboto Slab\\\", sans-serif;\\n  }\\n\\n  h1.is-favorite {\\n    background: #01a129;\\n    color: white;\\n    padding: 0 0.5rem;\\n    border-radius: 5px;\\n  }\\n\\n  h2 {\\n    font-size: 1rem;\\n    color: #808080;\\n    margin: 0.5rem 0;\\n  }\\n\\n  p {\\n    font-size: 1.25rem;\\n    margin: 0;\\n  }\\n\\n  div {\\n    text-align: right;\\n  }\\n\\n  .changing-fav {\\n    font: inherit;\\n    border: 1px solid #cf0056;\\n    background: #cf0056;\\n    padding: 0.5rem 1rem;\\n    color: white;\\n    border-radius: 5px;\\n    box-shadow: 1px 1px 3px rgba(0, 0, 0, 0.26);\\n    cursor: progress;\\n  }\\n</style>\\n\\n<article>\\n  <header>\\n    <h1>\\n      {title} \\n      {#if isFav}\\n        <Badge>Favorite</Badge>\\n      {/if}\\n    </h1>\\n    <h2>{subtitle}</h2>\\n    <p>{address}</p>\\n  </header>\\n  <div class=\\\"image\\\">\\n    <img src=\\\"{imageUrl}\\\" alt=\\\"{title}\\\">\\n  </div>\\n  <div class=\\\"content\\\">\\n    <p>{description}</p>\\n  </div>\\n  <footer>\\n    <!-- <Button href=\\\"mailto:{email}\\\">Contact</Button> -->\\n    <Button mode=\\\"outline\\\" type=\\\"button\\\" on:click=\\\"{dispatch('edit-meetup', id)}\\\">Edit</Button>\\n    {#if isLoading}\\n      <span class=\\\"changing-fav\\\">{isFav? 'Unfavoriting' : 'Favoriting' }...</span>\\n    {:else}\\n      <Button \\n        type=\\\"button\\\" \\n        mode=\\\"outline\\\" \\n        color={isFav? null : 'success'}\\n        on:click=\\\"{onToggleFavorite}\\\">\\n        {isFav? 'Unfavorite' : 'Favorite'}\\n      </Button>\\n    {/if}\\n    <Button type=\\\"button\\\" on:click=\\\"{() => dispatch('show-details', id)}\\\">Show Details</Button>\\n  </footer>\\n</article>\"],\"names\":[],\"mappings\":\"AA2CE,OAAO,4BAAC,CAAC,AACP,UAAU,CAAE,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CACzC,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,KAAK,CACjB,MAAM,CAAE,IAAI,AACd,CAAC,AAED,kCAAM,CACN,oCAAQ,CACR,MAAM,4BAAC,CAAC,AACN,OAAO,CAAE,IAAI,AACf,CAAC,AAED,MAAM,4BAAC,CAAC,AACN,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,KAAK,AACf,CAAC,AAED,oBAAM,CAAC,GAAG,cAAC,CAAC,AACV,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,KAAK,AACnB,CAAC,AAED,EAAE,4BAAC,CAAC,AACF,SAAS,CAAE,OAAO,CAClB,MAAM,CAAE,MAAM,CAAC,CAAC,CAChB,WAAW,CAAE,aAAa,CAAC,CAAC,UAAU,AACxC,CAAC,AASD,EAAE,4BAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,OAAO,CACd,MAAM,CAAE,MAAM,CAAC,CAAC,AAClB,CAAC,AAED,CAAC,4BAAC,CAAC,AACD,SAAS,CAAE,OAAO,CAClB,MAAM,CAAE,CAAC,AACX,CAAC,AAED,GAAG,4BAAC,CAAC,AACH,UAAU,CAAE,KAAK,AACnB,CAAC,AAED,aAAa,4BAAC,CAAC,AACb,IAAI,CAAE,OAAO,CACb,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CACzB,UAAU,CAAE,OAAO,CACnB,OAAO,CAAE,MAAM,CAAC,IAAI,CACpB,KAAK,CAAE,KAAK,CACZ,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAC3C,MAAM,CAAE,QAAQ,AAClB,CAAC\"}"
};
...
const MeetupItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<article class="${"svelte-if5wql"}"><header class="${"svelte-if5wql"}"><h1 class="${"svelte-if5wql"}">${escape(title)} 
      ${isFav
	...
	: ``}</h1>
    <h2 class="${"svelte-if5wql"}">${escape(subtitle)}</h2>
    <p class="${"svelte-if5wql"}">${escape(address)}</p></header>
  <div class="${"image svelte-if5wql"}"><img${add_attribute("src", imageUrl, 0)}${add_attribute("alt", title, 0)} class="${"svelte-if5wql"}"></div>
  <div class="${"content svelte-if5wql"}"><p class="${"svelte-if5wql"}">${escape(description)}</p></div>
  <footer class="${"svelte-if5wql"}">
...
const MeetupDetail = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <div class="${"content svelte-8ez2ph"}"><h1 class="${"svelte-8ez2ph"}">${escape(selectedMeetup.title)}</h1>
    ...
    ${validate_component(Button, "Button").$$render($$result, { type: "button", mode: "outline" }, {}, {
		default: () => {
			return `Close`;
		}
	})}</div>
